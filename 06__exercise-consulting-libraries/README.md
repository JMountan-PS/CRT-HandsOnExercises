# Exercise 6 - Consulting Libraries!

Welcome to **Exercise 6**. Find out great assets you can put in your toolbox.
...
1. Create a new empty suite **exercise 6 consulting libraries**

2. Create a folder in the root named **06__exercise-consulting-libraries**

3. In this folder, create file libraries.robot and copy the contents from here [libaries.robot](libraries.robot)

4. Use Big Live Test button and run step by step test case Exercise 6 - Consulting Libraries

# Explore and view the QWord Palette

1. In the folder **06__exercise-consulting-libraries**, open file libraries.robot
